A Terraform/CX as Code remote module for the following Dynamics 365 API operation: Get Most Recent Lead By Phone Number
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/dynamics-365-get-most-recent-lead-by-phone-number-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Most Recent Lead By Phone Number"
...
`Note:` The remote module for creating this data action integration can be found [here](https://github.com/GenesysCloudDevOps/microsoft-dynamics-data-actions-integration-module "Opens github.com/GenesysCloudDevOps/microsoft-dynamics-data-actions-integration-module")
